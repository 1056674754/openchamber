  ...
  const remoteIndicator = remoteIndicatorProject ? (
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          <Icon name="computer" className="h-3.5 w-3.5" style={{ color: remoteStatusColor, transition: 'color 0.2s' }}  />
        </span>
      </TooltipTrigger>
      <TooltipContent side="right" sideOffset={8} className="max-w-xs text-left">
        <div className="flex flex-col gap-1 text-xs">
          <div className="flex items-center gap-2">
            <Icon name="computer" className="h-3.5 w-3.5 flex-shrink-0" style={{ color: remoteStatusColor }}  />
