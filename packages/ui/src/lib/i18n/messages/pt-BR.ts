...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "sessions.sidebar.header.actions.addLocalProject": "Diretório local",
  "sessions.sidebar.header.actions.addRemoteProject": "Diretório remoto",
  "sessions.sidebar.header.actions.newSession": "Nova sessão",
  "sessions.sidebar.header.actions.newTempSession": "Nova sessão temporária",
  "sessions.sidebar.header.actions.newMultiRun": "Novo Multi-Run",
  "sessions.sidebar.header.actions.refresh": "Atualizar",
  ...
  "sessions.sidebar.tempSession.title": "Temporária",
  "sessions.sidebar.tempSession.empty": "Nova sessão temporária",
  "sessions.sidebar.tempSession.createNew": "Criar sessão temporária",
  "sessions.sidebar.tempSession.archive": "Arquivar",
  "sessions.sidebar.tempSession.confirmArchive": "Confirmar arquivamento",
  "sessions.sidebar.tempSession.confirm": "Confirmar",
  "sessions.sidebar.tempSession.createError": "Falha ao criar sessão temporária",
"sessions.sidebar.tempSession.archiveError": "Falha ao arquivar sessão temporária",
"sessions.sidebar.tempSession.creating": "Criando...",
"sessions.sidebar.tempSession.unavailable": "Este tópico temporário não tem histórico de chat. Arquive-o e crie uma nova sessão temporária.",
"sessions.sidebar.tempSession.defaultTopic": "sessao-temporaria",
  ...
  "sessions.sidebar.bulkActions.archiveConfirm": "Confirmar arquivamento",
  "sessions.sidebar.bulkActions.deleteConfirm": "Confirmar exclusão",
  ...
  "sessions.sidebar.project.actions.refresh": "Atualizar",
  ...
  "sessions.sidebar.session.menu.pinGlobal": "Fixar globalmente",
  "sessions.sidebar.session.menu.pinToProject": "Fixar ao projeto",
  "sessions.sidebar.session.menu.unpinGlobal": "Desfixar globalmente",
  ...
  "sessions.sidebar.session.menu.refresh": "Atualizar",
  ...
  "sessions.sidebar.session.menu.delete": "Excluir",
  "sessions.sidebar.session.menu.regenerateTitle": "Regenerar título com IA",
  "sessions.sidebar.session.regenerateTitle.dialogTitle": "Regenerar título com IA",
  "sessions.sidebar.session.regenerateTitle.loading": "Gerando candidatos de título...",
  "sessions.sidebar.session.regenerateTitle.error": "Falha ao gerar títulos",
  "sessions.sidebar.session.regenerateTitle.noCandidates": "Nenhum candidato gerado.",
  "sessions.sidebar.session.regenerateTitle.selectCandidate": "Selecione um candidato:",
  "sessions.sidebar.session.regenerateTitle.editLabel": "Editar título selecionado:",
  "sessions.sidebar.session.regenerateTitle.apply": "Aplicar",
  "sessions.sidebar.session.regenerateTitle.cancel": "Cancelar",
  "sessions.sidebar.session.regenerateTitle.regenerate": "Regenerar",
  "sessions.sidebar.session.regenerateTitle.toastApplied": "Título atualizado",
  "sessions.sidebar.session.regenerateTitle.toastError": "Falha ao atualizar título",
  "sessions.sidebar.session.untitled": "Sessão sem título",
  "sessions.sidebar.session.export.nothingToExport": "Nada para exportar",
  "sessions.sidebar.session.export.success": "Sessão exportada",
  "sessions.sidebar.session.export.failedRevealPath": "Não foi possível revelar o caminho",
  "sessions.sidebar.session.export.untitledSubagent": "Subagente sem título",
  "sessions.sidebar.session.export.skippedSubtaskSingle": "A sessão foi exportada, mas {count} tarefa de subagente que não pôde ser carregada foi ignorada.",
  "sessions.sidebar.session.export.skippedSubtaskMany": "A sessão foi exportada, mas {count} tarefas de subagente que não puderam ser carregadas foram ignoradas.",
  ...
  "sessions.sidebar.session.status.pinnedGlobal": "Sessão fixada globalmente",
  "sessions.sidebar.activity.globalPinnedTitle": "Fixados globalmente",
  "sessions.sidebar.session.status.remoteInstance": "Instância remota: {status}",
  "sessions.sidebar.session.status.remoteProjectDir": "Diretório do projeto:",
  "sessions.sidebar.remote.connected": "Conectado",
  "sessions.sidebar.remote.disconnected": "Desconectado",
  ...
  "contextPanel.mode.terminal": "Terminal",
  "contextPanel.split.dropTopHint": "Solte para dividir (acima)",
  "contextPanel.split.dropBottomHint": "Solte para dividir (abaixo)",
  "contextPanel.split.closeSplitAria": "Fechar painel dividido",
  "contextPanel.split.resizeAria": "Redimensionar painéis divididos",
  ...
  "header.actions.toggleContextPanelAria": "Mostrar ou ocultar painel de contexto",
  ...
  "remoteDirectoryExplorer.title": "Adicionar projeto remoto",
  "remoteDirectoryExplorer.selectHost": "Selecionar servidor remoto",
  "remoteDirectoryExplorer.noHosts": "Nenhum servidor remoto conectado",
  "remoteDirectoryExplorer.pathPlaceholder": "Inserir caminho...",
  "remoteDirectoryExplorer.loading": "Carregando...",
  "remoteDirectoryExplorer.noFolders": "Nenhuma pasta encontrada",
  "remoteDirectoryExplorer.addProject": "Adicionar projeto",
  "remoteDirectoryExplorer.alreadyAdded": "Já adicionado",
  "remoteDirectoryExplorer.success": "Projeto remoto adicionado",
  "remoteDirectoryExplorer.error": "Falha ao adicionar projeto remoto",
  "remoteDirectoryExplorer.errorFetchHome": "Falha ao determinar diretório home remoto",
  "remoteDirectoryExplorer.errorFetchHomeDetail": "Não foi possível obter o diretório home de {host}. O servidor remoto pode não estar em execução ou a conexão foi perdida.",
  "remoteDirectoryExplorer.errorFetchList": "Falha ao navegar diretório remoto",
  "remoteDirectoryExplorer.errorFetchListDetail": "Não foi possível listar o conteúdo de {path} em {host}. {detail}",
  "remoteDirectoryExplorer.folders": "Pastas",
  "remoteDirectoryExplorer.retry": "Tentar novamente",
  "remoteDirectoryExplorer.connect": "Conectar",
  "remoteDirectoryExplorer.phaseConnecting": "Conectando...",
  "remoteDirectoryExplorer.phaseConnected": "Conectado",
  "remoteDirectoryExplorer.phaseError": "Falha na conexão",
  ...
  "chat.file.notFound": "Arquivo não encontrado",
...
"chat.emptyState.creatingSession": "Criando sessão\u2026",
  ...
  "chat.revertConfirm.title": "Revert from here?",
  "chat.revertConfirm.description": "This will remove all messages after this point and restore files to their state at this message.",
  "chat.revertConfirm.cancel": "Cancel",
  "chat.revertConfirm.confirm": "Revert",
  ...
  "chat.chatInput.actions.sendImmediatelyAria": "Enviar imediatamente",
  "chat.chatInput.actions.sendImmediatelyTooltip": "Enviar esta mensagem imediatamente",
  "chat.chatInput.actions.queueMessageAria": "Colocar mensagem na fila",
  "chat.chatInput.actions.queueMessageTooltip": "Colocar esta mensagem na fila; ela será enviada quando o agente terminar",
  "chat.chatInput.actions.queueButton.enter": "Clique para {action}",
  "chat.chatInput.actions.queueButton.ctrlEnter": "{ctrlKey}+clique para {action}",
  "chat.chatInput.actions.queueButton.queue": "colocar na fila",
  "chat.chatInput.actions.queueButton.send": "enviar imediatamente",
  ...
  "chat.compaction.compacting": "Compactando…",
  "chat.compaction.compacted": "Compactado",
  "chat.reasoning.thinking": "Pensando…",
  "chat.reasoning.thought": "Pensamento",
...
"desktopHostSwitcher.sshPhase.installingOpenCode": "Instalando OpenCode",
"desktopHostSwitcher.sshPhase.updating": "Atualizando",
  ...
  'instanceInfoPanel.title': 'Instância',
  'instanceInfoPanel.empty.noServerFound': 'Servidor não encontrado',
  'instanceInfoPanel.empty.hint': 'A sessão ativa não pertence a um servidor registrado',
  'instanceInfoPanel.status.healthy': 'Saudável',
  'instanceInfoPanel.status.unhealthy': 'Não saudável',
  'instanceInfoPanel.status.connecting': 'Conectando',
  'instanceInfoPanel.status.unknown': 'Desconhecido',
  'instanceInfoPanel.row.status': 'Status',
  'instanceInfoPanel.row.version': 'Versão OpenCode',
  'instanceInfoPanel.row.skills': 'Skills carregados',
  'instanceInfoPanel.row.sshStatus': 'Conexão SSH',
  'instanceInfoPanel.version.fetching': 'Obtendo...',
  'instanceInfoPanel.version.unknown': 'Desconhecido',
  'instanceInfoPanel.skills.count': '{count} skills',
  'instanceInfoPanel.row.plugins': 'Plugins',
  'instanceInfoPanel.plugins.count': '{count} plugins',
  'instanceInfoPanel.plugins.none': 'Nenhum',
  'instanceInfoPanel.sshPhase.ready': 'Pronto',
  'instanceInfoPanel.sshPhase.error': 'Erro',
  'instanceInfoPanel.sshPhase.reconnecting': 'Reconectando',
  'instanceInfoPanel.sshPhase.resolvingConfig': 'Resolvendo configuração',
  'instanceInfoPanel.sshPhase.checkingAuth': 'Verificando autenticação',
  'instanceInfoPanel.sshPhase.connectingSsh': 'Conectando via SSH',
  'instanceInfoPanel.sshPhase.probingRemote': 'Explorando remoto',
'instanceInfoPanel.sshPhase.installing': 'Instalando',
'instanceInfoPanel.sshPhase.installingOpenCode': 'Instalando OpenCode CLI',
'instanceInfoPanel.sshPhase.updating': 'Atualizando',
  'instanceInfoPanel.sshPhase.detectingServer': 'Detectando servidor',
  'instanceInfoPanel.sshPhase.startingServer': 'Iniciando servidor',
  'instanceInfoPanel.sshPhase.forwardingPorts': 'Encaminhando portas',
  'instanceInfoPanel.sshPhase.idle': 'Inativo',
  'instanceInfoPanel.actions.refreshAria': 'Atualizar informações da instância',
  'instanceInfoPanel.actions.manageSettings': 'Gerenciar nas Configurações',
};
