...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.header.actions.addLocalProject": "Directorio local",
  "sessions.sidebar.header.actions.addRemoteProject": "Directorio remoto",
  "sessions.sidebar.header.actions.newSession": "Nueva sesión",
  "sessions.sidebar.header.actions.newTempSession": "Nueva sesión temporal",
  "sessions.sidebar.header.actions.newMultiRun": "Nuevo multi-run",
  "sessions.sidebar.header.actions.refresh": "Actualizar",
  ...
  "sessions.sidebar.tempSession.title": "Temporal",
  "sessions.sidebar.tempSession.empty": "Nueva sesión temporal",
  "sessions.sidebar.tempSession.createNew": "Crear sesión temporal",
  "sessions.sidebar.tempSession.archive": "Archivar",
  "sessions.sidebar.tempSession.confirmArchive": "Confirmar archivado",
  "sessions.sidebar.tempSession.confirm": "Confirmar",
  "sessions.sidebar.tempSession.createError": "Error al crear sesión temporal",
"sessions.sidebar.tempSession.archiveError": "Error al archivar sesión temporal",
"sessions.sidebar.tempSession.creating": "Creando...",
"sessions.sidebar.tempSession.unavailable": "Este tema temporal no tiene historial de chat. Archívalo y crea una nueva sesión temporal.",
"sessions.sidebar.tempSession.defaultTopic": "sesion-temporal",
  ...
  "sessions.sidebar.bulkActions.archiveConfirm": "Confirmar archivo",
  "sessions.sidebar.bulkActions.deleteConfirm": "Confirmar eliminación",
  ...
  "sessions.sidebar.project.actions.refresh": "Actualizar",
  ...
  "sessions.sidebar.session.menu.pinGlobal": "Anclar globalmente",
  "sessions.sidebar.session.menu.pinToProject": "Anclar al proyecto",
  "sessions.sidebar.session.menu.unpinGlobal": "Desanclar globalmente",
  ...
  "sessions.sidebar.session.menu.refresh": "Actualizar",
  ...
  "sessions.sidebar.session.menu.regenerateTitle": "Regenerar título con IA",
  "sessions.sidebar.session.regenerateTitle.dialogTitle": "Regenerar título con IA",
  "sessions.sidebar.session.regenerateTitle.loading": "Generando candidatos de título...",
  "sessions.sidebar.session.regenerateTitle.error": "Error al generar títulos",
  "sessions.sidebar.session.regenerateTitle.noCandidates": "No se generaron candidatos.",
  "sessions.sidebar.session.regenerateTitle.selectCandidate": "Selecciona un candidato:",
  "sessions.sidebar.session.regenerateTitle.editLabel": "Editar título seleccionado:",
  ...
  "sessions.sidebar.session.regenerateTitle.toastApplied": "Título actualizado",
  "sessions.sidebar.session.regenerateTitle.toastError": "Error al actualizar el título",
  ...
  "sessions.sidebar.session.export.skippedSubtaskSingle": "Se exportó la sesión, pero se omitió {count} tarea de subagente que no se pudo cargar.",
  "sessions.sidebar.session.export.skippedSubtaskMany": "Se exportó la sesión, pero se omitieron {count} tareas de subagente que no se pudieron cargar.",
  ...
  "sessions.sidebar.session.status.unread": "Actualizaciones sin leer",
  "sessions.sidebar.session.status.pinned": "Sesión anclada",
  "sessions.sidebar.session.status.pinnedGlobal": "Sesión anclada globalmente",
  "sessions.sidebar.activity.globalPinnedTitle": "Global fijado",
  "sessions.sidebar.session.status.remoteInstance": "Instancia remota: {status}",
  "sessions.sidebar.session.status.remoteProjectDir": "Directorio del proyecto:",
  ...
  "contextPanel.split.dropTopHint": "Soltar para dividir (arriba)",
  "contextPanel.split.dropBottomHint": "Soltar para dividir (abajo)",
  "contextPanel.split.closeSplitAria": "Cerrar panel dividido",
  "contextPanel.split.resizeAria": "Redimensionar paneles divididos",
  ...
  "header.actions.toggleContextPanelAria": "Mostrar u ocultar panel de contexto",
  ...
  "remoteDirectoryExplorer.title": "Añadir proyecto remoto",
  "remoteDirectoryExplorer.selectHost": "Seleccionar servidor remoto",
  "remoteDirectoryExplorer.noHosts": "No hay servidores remotos conectados",
  "remoteDirectoryExplorer.pathPlaceholder": "Introducir ruta...",
  "remoteDirectoryExplorer.loading": "Cargando...",
  "remoteDirectoryExplorer.noFolders": "No se encontraron carpetas",
  "remoteDirectoryExplorer.addProject": "Añadir proyecto",
  "remoteDirectoryExplorer.alreadyAdded": "Ya añadido",
  "remoteDirectoryExplorer.success": "Proyecto remoto añadido",
  "remoteDirectoryExplorer.error": "Error al añadir proyecto remoto",
  "remoteDirectoryExplorer.errorFetchHome": "No se pudo determinar el directorio home remoto",
  "remoteDirectoryExplorer.errorFetchHomeDetail": "No se pudo obtener el directorio home de {host}. El servidor remoto puede no estar ejecutándose o la conexión se perdió.",
  "remoteDirectoryExplorer.errorFetchList": "Error al explorar directorio remoto",
  "remoteDirectoryExplorer.errorFetchListDetail": "No se pudo listar el contenido de {path} en {host}. {detail}",
  "remoteDirectoryExplorer.folders": "Carpetas",
  "remoteDirectoryExplorer.retry": "Reintentar",
  ...
  "remoteDirectoryExplorer.phaseError": "Error de conexión",
  ...
  "chat.file.notFound": "Archivo no encontrado",
...
"chat.emptyState.creatingSession": "Creando sesión\u2026",
  ...
  "chat.chatInput.actions.sendImmediatelyAria": "Enviar inmediatamente",
  "chat.chatInput.actions.sendImmediatelyTooltip": "Enviar este mensaje inmediatamente",
  "chat.chatInput.actions.queueMessageAria": "Poner mensaje en cola",
  "chat.chatInput.actions.queueMessageTooltip": "Poner este mensaje en cola; se enviará cuando el agente termine",
  "chat.chatInput.actions.queueButton.enter": "Clic para {action}",
  "chat.chatInput.actions.queueButton.ctrlEnter": "{ctrlKey}+clic para {action}",
  "chat.chatInput.actions.queueButton.queue": "poner en cola",
  "chat.chatInput.actions.queueButton.send": "enviar inmediatamente",
...
"desktopHostSwitcher.sshPhase.updating": "Actualizando",
  ...
  'instanceInfoPanel.title': 'Instancia',
  'instanceInfoPanel.empty.noServerFound': 'Servidor no encontrado',
  'instanceInfoPanel.empty.hint': 'La sesión activa no pertenece a un servidor registrado',
  'instanceInfoPanel.status.healthy': 'Saludable',
  'instanceInfoPanel.status.unhealthy': 'No saludable',
  'instanceInfoPanel.status.connecting': 'Conectando',
  'instanceInfoPanel.status.unknown': 'Desconocido',
  'instanceInfoPanel.row.status': 'Estado',
  'instanceInfoPanel.row.version': 'Versión OpenCode',
  'instanceInfoPanel.row.skills': 'Skills cargados',
  'instanceInfoPanel.row.sshStatus': 'Conexión SSH',
  'instanceInfoPanel.version.fetching': 'Obteniendo...',
  'instanceInfoPanel.version.unknown': 'Desconocido',
  ...
  'instanceInfoPanel.plugins.none': 'Ninguno',
  'instanceInfoPanel.sshPhase.ready': 'Listo',
  'instanceInfoPanel.sshPhase.error': 'Error',
  'instanceInfoPanel.sshPhase.reconnecting': 'Reconectando',
  'instanceInfoPanel.sshPhase.resolvingConfig': 'Resolviendo configuración',
  'instanceInfoPanel.sshPhase.checkingAuth': 'Verificando autenticación',
  'instanceInfoPanel.sshPhase.connectingSsh': 'Conectando vía SSH',
...
'instanceInfoPanel.sshPhase.updating': 'Actualizando',
  ...
  'instanceInfoPanel.sshPhase.forwardingPorts': 'Reenviando puertos',
