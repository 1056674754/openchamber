...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.header.actions.addLocalProject': '로컬 디렉토리',
  'sessions.sidebar.header.actions.addRemoteProject': '원격 디렉토리',
  'sessions.sidebar.header.actions.newSession': '새 세션',
  'sessions.sidebar.header.actions.newTempSession': '새 임시 세션',
  'sessions.sidebar.header.actions.newMultiRun': '새 다중 실행',
  'sessions.sidebar.header.actions.refresh': '새로고침',
  ...
  'sessions.sidebar.tempSession.title': '임시',
  'sessions.sidebar.tempSession.empty': '새 임시 세션',
  'sessions.sidebar.tempSession.createNew': '임시 세션 생성',
  'sessions.sidebar.tempSession.archive': '보관',
  'sessions.sidebar.tempSession.confirmArchive': '보관 확인',
  'sessions.sidebar.tempSession.confirm': '확인',
  'sessions.sidebar.tempSession.createError': '임시 세션 생성 실패',
'sessions.sidebar.tempSession.archiveError': '임시 세션 보관 실패',
'sessions.sidebar.tempSession.creating': '생성 중...',
'sessions.sidebar.tempSession.unavailable': '이 임시 주제에는 채팅 기록이 없습니다. 보관한 뒤 새 임시 세션을 시작하세요.',
'sessions.sidebar.tempSession.defaultTopic': '임시-세션',
  ...
  'sessions.sidebar.bulkActions.archiveConfirm': '보관 확인',
  'sessions.sidebar.bulkActions.deleteConfirm': '삭제 확인',
  ...
  'sessions.sidebar.project.actions.refresh': '새로고침',
  ...
  'sessions.sidebar.session.menu.pinGlobal': '전역 고정',
  'sessions.sidebar.session.menu.pinToProject': '프로젝트에 고정',
  'sessions.sidebar.session.menu.unpinGlobal': '전역 고정 해제',
  ...
  'sessions.sidebar.session.menu.refresh': '새로고침',
  ...
  'sessions.sidebar.session.menu.regenerateTitle': 'AI 제목 재생성',
  'sessions.sidebar.session.regenerateTitle.dialogTitle': 'AI 제목 재생성',
  'sessions.sidebar.session.regenerateTitle.loading': '제목 후보 생성 중...',
  'sessions.sidebar.session.regenerateTitle.error': '제목 생성 실패',
  'sessions.sidebar.session.regenerateTitle.noCandidates': '생성된 후보가 없습니다.',
  'sessions.sidebar.session.regenerateTitle.selectCandidate': '후보를 선택하세요:',
  'sessions.sidebar.session.regenerateTitle.editLabel': '선택한 제목 편집:',
  'sessions.sidebar.session.regenerateTitle.apply': '적용',
  'sessions.sidebar.session.regenerateTitle.cancel': '취소',
  'sessions.sidebar.session.regenerateTitle.regenerate': '재생성',
  'sessions.sidebar.session.regenerateTitle.toastApplied': '제목이 업데이트되었습니다',
  'sessions.sidebar.session.regenerateTitle.toastError': '제목 업데이트 실패',
  ...
  'sessions.sidebar.session.export.failedRevealPath': '경로를 표시하지 못했습니다',
  'sessions.sidebar.session.export.untitledSubagent': '제목 없는 하위 에이전트',
  'sessions.sidebar.session.export.skippedSubtaskSingle': '세션을 내보냈지만 로드할 수 없는 하위 에이전트 작업 {count}개를 건너뛰었습니다.',
  'sessions.sidebar.session.export.skippedSubtaskMany': '세션을 내보냈지만 로드할 수 없는 하위 에이전트 작업 {count}개를 건너뛰었습니다.',
  'sessions.sidebar.session.export.dialog.title': 'Markdown 내보내기',
  'sessions.sidebar.session.export.dialog.descriptionSingle': '이 세션에는 하위 에이전트 작업 {count}개가 있습니다. 내보내기에 포함할까요?',
  'sessions.sidebar.session.export.dialog.descriptionMany': '이 세션에는 하위 에이전트 작업 {count}개가 있습니다. 내보내기에 포함할까요?',
  'sessions.sidebar.session.export.dialog.includeSubtasks': '하위 에이전트 작업 포함',
  'sessions.sidebar.session.export.dialog.confirm': '내보내기',
  'sessions.sidebar.session.status.active': '세션 활성',
  'sessions.sidebar.session.status.unread': '읽지 않은 업데이트',
  'sessions.sidebar.session.status.pinned': '고정된 세션',
  'sessions.sidebar.session.status.pinnedGlobal': '전역 고정된 세션',
  'sessions.sidebar.activity.globalPinnedTitle': '전역 고정',
  'sessions.sidebar.session.status.remoteInstance': '원격 인스턴스: {status}',
  'sessions.sidebar.session.status.remoteProjectDir': '프로젝트 디렉터리:',
  'sessions.sidebar.remote.connected': '연결됨',
  'sessions.sidebar.remote.disconnected': '연결 해제됨',
  ...
  'contextPanel.mode.terminal': '터미널',
  'contextPanel.split.dropTopHint': '놓아서 분할(위)',
  'contextPanel.split.dropBottomHint': '놓아서 분할(아래)',
  'contextPanel.split.closeSplitAria': '분할 창 닫기',
  'contextPanel.split.resizeAria': '분할 창 크기 조정',
  ...
  'header.actions.toggleContextPanelAria': '컨텍스트 패널 토글',
  ...
  'remoteDirectoryExplorer.title': '원격 프로젝트 추가',
  'remoteDirectoryExplorer.selectHost': '원격 서버 선택',
  'remoteDirectoryExplorer.noHosts': '연결된 원격 서버 없음',
  'remoteDirectoryExplorer.pathPlaceholder': '경로 입력...',
  'remoteDirectoryExplorer.loading': '로딩 중...',
  'remoteDirectoryExplorer.noFolders': '폴더 없음',
  'remoteDirectoryExplorer.addProject': '프로젝트 추가',
  'remoteDirectoryExplorer.alreadyAdded': '이미 추가됨',
  'remoteDirectoryExplorer.success': '원격 프로젝트가 추가되었습니다',
  'remoteDirectoryExplorer.error': '원격 프로젝트 추가 실패',
  'remoteDirectoryExplorer.errorFetchHome': '원격 홈 디렉토리를 확인할 수 없습니다',
  'remoteDirectoryExplorer.errorFetchHomeDetail': '{host}에서 홈 디렉토리를 가져올 수 없습니다. 원격 서버가 실행 중이지 않거나 연결이 끊어졌을 수 있습니다.',
  'remoteDirectoryExplorer.errorFetchList': '원격 디렉토리 탐색 실패',
  'remoteDirectoryExplorer.errorFetchListDetail': '{host}의 {path} 내용을 나열할 수 없습니다. {detail}',
  'remoteDirectoryExplorer.folders': '폴더',
  'remoteDirectoryExplorer.retry': '재시도',
  'remoteDirectoryExplorer.connect': '연결',
  'remoteDirectoryExplorer.phaseConnecting': '연결 중...',
  'remoteDirectoryExplorer.phaseConnected': '연결됨',
  'remoteDirectoryExplorer.phaseError': '연결 실패',
...
'chat.emptyState.creatingSession': '세션 생성 중\u2026',
  ...
  'chat.chatInput.actions.sendImmediatelyAria': '즉시 보내기',
  'chat.chatInput.actions.sendImmediatelyTooltip': '이 메시지를 즉시 보냅니다',
  'chat.chatInput.actions.queueMessageAria': '메시지 대기열에 추가',
  'chat.chatInput.actions.queueMessageTooltip': '이 메시지를 대기열에 추가합니다. 에이전트가 완료된 후 전송됩니다',
  'chat.chatInput.actions.queueButton.enter': '클릭하여 {action}',
  'chat.chatInput.actions.queueButton.ctrlEnter': '{ctrlKey}+클릭하여 {action}',
  'chat.chatInput.actions.queueButton.queue': '대기열에 추가',
  'chat.chatInput.actions.queueButton.send': '즉시 보내기',
  ...
  'chat.compaction.compacting': '압축 중…',
  'chat.compaction.compacted': '압축됨',
  'chat.reasoning.thinking': '생각 중…',
  'chat.reasoning.thought': '생각 완료',
...
'desktopHostSwitcher.sshPhase.installingOpenCode': 'OpenCode 설치 중',
'desktopHostSwitcher.sshPhase.updating': '업데이트 중',
  ...
  'instanceInfoPanel.title': '인스턴스',
  'instanceInfoPanel.empty.noServerFound': '서버를 찾을 수 없음',
  'instanceInfoPanel.empty.hint': '활성 세션이 등록된 서버에 속해 있지 않음',
  'instanceInfoPanel.status.healthy': '정상',
  'instanceInfoPanel.status.unhealthy': '비정상',
  'instanceInfoPanel.status.connecting': '연결 중',
  'instanceInfoPanel.status.unknown': '알 수 없음',
  'instanceInfoPanel.row.status': '상태',
  'instanceInfoPanel.row.version': 'OpenCode 버전',
  'instanceInfoPanel.row.skills': '로드된 스킬',
  'instanceInfoPanel.row.sshStatus': 'SSH 연결',
  'instanceInfoPanel.version.fetching': '가져오는 중...',
  'instanceInfoPanel.version.unknown': '알 수 없음',
  'instanceInfoPanel.skills.count': '{count} 스킬',
  'instanceInfoPanel.row.plugins': '플러그인',
  'instanceInfoPanel.plugins.count': '{count} 플러그인',
  'instanceInfoPanel.plugins.none': '없음',
  'instanceInfoPanel.sshPhase.ready': '준비 완료',
  'instanceInfoPanel.sshPhase.error': '오류',
  'instanceInfoPanel.sshPhase.reconnecting': '재연결 중',
  'instanceInfoPanel.sshPhase.resolvingConfig': '설정 확인 중',
  'instanceInfoPanel.sshPhase.checkingAuth': '인증 확인 중',
  'instanceInfoPanel.sshPhase.connectingSsh': 'SSH 연결 중',
  'instanceInfoPanel.sshPhase.probingRemote': '원격 탐색 중',
'instanceInfoPanel.sshPhase.installing': '설치 중',
'instanceInfoPanel.sshPhase.installingOpenCode': 'OpenCode CLI 설치 중',
'instanceInfoPanel.sshPhase.updating': '업데이트 중',
  'instanceInfoPanel.sshPhase.detectingServer': '서버 감지 중',
  'instanceInfoPanel.sshPhase.startingServer': '서버 시작 중',
  'instanceInfoPanel.sshPhase.forwardingPorts': '포트 포워딩 중',
  'instanceInfoPanel.sshPhase.idle': '대기 중',
  'instanceInfoPanel.actions.refreshAria': '인스턴스 정보 새로 고침',
  'instanceInfoPanel.actions.manageSettings': '설정에서 관리',
};
