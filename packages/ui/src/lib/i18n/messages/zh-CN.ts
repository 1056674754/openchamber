...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.header.actions.addLocalProject': '本地目录',
  'sessions.sidebar.header.actions.addRemoteProject': '远程目录',
  'sessions.sidebar.header.actions.newSession': '新建会话',
  'sessions.sidebar.header.actions.newTempSession': '新建临时会话',
  'sessions.sidebar.header.actions.newMultiRun': '新建多运行',
  'sessions.sidebar.header.actions.refresh': '刷新',
  ...
  'sessions.sidebar.tempSession.title': '临时',
  'sessions.sidebar.tempSession.empty': '新建临时',
  'sessions.sidebar.tempSession.createNew': '创建临时',
  'sessions.sidebar.tempSession.archive': '归档',
  'sessions.sidebar.tempSession.confirmArchive': '确认归档',
  'sessions.sidebar.tempSession.confirm': '确认',
  'sessions.sidebar.tempSession.createError': '创建临时会话失败',
'sessions.sidebar.tempSession.archiveError': '归档临时会话失败',
'sessions.sidebar.tempSession.creating': '创建中...',
'sessions.sidebar.tempSession.unavailable': '这个临时话题没有聊天历史。请归档后重新创建临时会话。',
'sessions.sidebar.tempSession.defaultTopic': '临时',
  ...
  'sessions.sidebar.bulkActions.archiveConfirm': '确认归档',
  'sessions.sidebar.bulkActions.deleteConfirm': '确认删除',
  ...
  'sessions.sidebar.project.actions.refresh': '刷新',
  ...
  'sessions.sidebar.session.menu.pinGlobal': '全局置顶',
  'sessions.sidebar.session.menu.pinToProject': '置顶到项目',
  'sessions.sidebar.session.menu.unpinGlobal': '取消全局置顶',
  ...
  'sessions.sidebar.session.menu.refresh': '刷新',
  ...
  'sessions.sidebar.session.menu.regenerateTitle': 'AI 重新生成标题',
  'sessions.sidebar.session.regenerateTitle.dialogTitle': 'AI 重新生成标题',
  'sessions.sidebar.session.regenerateTitle.loading': '正在生成标题候选...',
  'sessions.sidebar.session.regenerateTitle.error': '生成标题失败',
  'sessions.sidebar.session.regenerateTitle.noCandidates': '未生成候选标题。',
  'sessions.sidebar.session.regenerateTitle.selectCandidate': '选择一个候选标题：',
  'sessions.sidebar.session.regenerateTitle.editLabel': '编辑选中的标题：',
  'sessions.sidebar.session.regenerateTitle.apply': '应用',
  'sessions.sidebar.session.regenerateTitle.cancel': '取消',
  'sessions.sidebar.session.regenerateTitle.regenerate': '重新生成',
  'sessions.sidebar.session.regenerateTitle.toastApplied': '标题已更新',
  'sessions.sidebar.session.regenerateTitle.toastError': '更新标题失败',
  ...
  'sessions.sidebar.session.status.pinnedGlobal': '全局置顶会话',
  'sessions.sidebar.activity.globalPinnedTitle': '全局置顶',
  'sessions.sidebar.session.status.remoteInstance': '远程实例: {status}',
  'sessions.sidebar.session.status.remoteProjectDir': '项目目录:',
  'sessions.sidebar.remote.connected': '已连接',
  'sessions.sidebar.remote.disconnected': '已断开',
  ...
  'contextPanel.mode.terminal': '终端',
  'contextPanel.split.dropTopHint': '放下以拆分（上方）',
  'contextPanel.split.dropBottomHint': '放下以拆分（下方）',
  'contextPanel.split.closeSplitAria': '关闭拆分窗格',
  'contextPanel.split.resizeAria': '调整拆分窗格大小',
  ...
  'header.actions.toggleContextPanelAria': '切换上下文面板',
  ...
  'remoteDirectoryExplorer.title': '添加远程项目',
  'remoteDirectoryExplorer.selectHost': '选择远程服务器',
  'remoteDirectoryExplorer.noHosts': '未连接远程服务器',
  'remoteDirectoryExplorer.pathPlaceholder': '输入路径...',
  'remoteDirectoryExplorer.loading': '加载中...',
  'remoteDirectoryExplorer.noFolders': '未找到文件夹',
  'remoteDirectoryExplorer.addProject': '添加项目',
  'remoteDirectoryExplorer.alreadyAdded': '已添加',
  'remoteDirectoryExplorer.success': '远程项目已添加',
  'remoteDirectoryExplorer.error': '添加远程项目失败',
  'remoteDirectoryExplorer.errorFetchHome': '无法确定远程主目录',
  'remoteDirectoryExplorer.errorFetchHomeDetail': '无法从 {host} 获取主目录。远程服务器可能未运行或连接已断开。',
  'remoteDirectoryExplorer.errorFetchList': '浏览远程目录失败',
  'remoteDirectoryExplorer.errorFetchListDetail': '无法列出 {host} 上 {path} 的内容。{detail}',
  'remoteDirectoryExplorer.folders': '文件夹',
  'remoteDirectoryExplorer.retry': '重试',
  'remoteDirectoryExplorer.connect': '连接',
  'remoteDirectoryExplorer.phaseConnecting': '连接中...',
  'remoteDirectoryExplorer.phaseConnected': '已连接',
  'remoteDirectoryExplorer.phaseError': '连接失败',
...
'chat.emptyState.creatingSession': '正在创建会话\u2026',
  ...
  'chat.revertConfirm.title': '确认回退？',
  'chat.revertConfirm.description': '这将删除此消息之后的所有对话记录，并将代码恢复到该点状态。下面的对话将会丢失。',
  'chat.revertConfirm.cancel': '取消',
  'chat.revertConfirm.confirm': '回退',
  ...
  'chat.chatInput.actions.queueMessageTooltip': '将消息放入队列，等智能体完成当前工作后自动发送',
  'chat.chatInput.actions.sendImmediatelyAria': '直接发送',
  'chat.chatInput.actions.sendImmediatelyTooltip': '立即发送此消息',
  'chat.chatInput.actions.queueButton.enter': '点击：{action}',
  'chat.chatInput.actions.queueButton.ctrlEnter': '{ctrlKey}+点击：{action}',
  'chat.chatInput.actions.queueButton.queue': '加入队列',
  'chat.chatInput.actions.queueButton.send': '立即发送',
  ...
  'chat.compaction.compacting': '正在压缩…',
  'chat.compaction.compacted': '已压缩',
...
'desktopHostSwitcher.sshPhase.installingOpenCode': '正在安装 OpenCode',
'desktopHostSwitcher.sshPhase.updating': '更新中',
  ...
  'instanceInfoPanel.title': '实例',
  'instanceInfoPanel.empty.noServerFound': '未找到服务器',
  'instanceInfoPanel.empty.hint': '当前活动会话不属于已注册的服务器',
  'instanceInfoPanel.status.healthy': '健康',
  'instanceInfoPanel.status.unhealthy': '不健康',
  'instanceInfoPanel.status.connecting': '连接中',
  'instanceInfoPanel.status.unknown': '未知',
  'instanceInfoPanel.row.status': '状态',
  'instanceInfoPanel.row.version': 'OpenCode 版本',
  'instanceInfoPanel.row.skills': '已加载技能',
  'instanceInfoPanel.row.sshStatus': 'SSH 连接',
  'instanceInfoPanel.version.fetching': '获取中...',
  'instanceInfoPanel.version.unknown': '未知',
  'instanceInfoPanel.skills.count': '{count} 个技能',
  'instanceInfoPanel.row.plugins': '插件',
  'instanceInfoPanel.plugins.count': '{count} 个插件',
  'instanceInfoPanel.plugins.none': '无',
  'instanceInfoPanel.sshPhase.ready': '就绪',
  'instanceInfoPanel.sshPhase.error': '错误',
  'instanceInfoPanel.sshPhase.reconnecting': '重新连接中',
  'instanceInfoPanel.sshPhase.resolvingConfig': '解析配置中',
  'instanceInfoPanel.sshPhase.checkingAuth': '验证身份中',
  'instanceInfoPanel.sshPhase.connectingSsh': '通过 SSH 连接中',
  'instanceInfoPanel.sshPhase.probingRemote': '探测远程服务器中',
'instanceInfoPanel.sshPhase.installing': '安装中',
'instanceInfoPanel.sshPhase.installingOpenCode': '正在安装 OpenCode CLI',
'instanceInfoPanel.sshPhase.updating': '更新中',
  'instanceInfoPanel.sshPhase.detectingServer': '检测服务器中',
  'instanceInfoPanel.sshPhase.startingServer': '启动服务器中',
  'instanceInfoPanel.sshPhase.forwardingPorts': '端口转发中',
