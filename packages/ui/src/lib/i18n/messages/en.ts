...
'sessions.sidebar.tempSession.archiveError': 'Failed to archive temp session',
'sessions.sidebar.tempSession.creating': 'Creating...',
'sessions.sidebar.tempSession.unavailable': 'This temp topic has no chat history. Archive it and start a new temp session.',
'sessions.sidebar.tempSession.defaultTopic': 'temp-session',
  ...
  'sessions.sidebar.session.menu.refresh': 'Refresh',
  ...
  'contextPanel.split.dropTopHint': 'Drop to split (top)',
  'contextPanel.split.dropBottomHint': 'Drop to split (bottom)',
  'contextPanel.split.closeSplitAria': 'Close split pane',
  'contextPanel.split.resizeAria': 'Resize split panes',
...
'chat.emptyState.creatingSession': 'Creating session\u2026',
  ...
  'chat.compaction.compacting': 'Compacting…',
  'chat.compaction.compacted': 'Compacted',
...
'desktopHostSwitcher.sshPhase.installingOpenCode': 'Installing OpenCode',
'desktopHostSwitcher.sshPhase.updating': 'Updating',
  ...
  'instanceInfoPanel.title': 'Instance',
  'instanceInfoPanel.empty.noServerFound': 'No server found',
  'instanceInfoPanel.empty.hint': 'The active session does not belong to a registered server',
  'instanceInfoPanel.status.healthy': 'Healthy',
  'instanceInfoPanel.status.unhealthy': 'Unhealthy',
  'instanceInfoPanel.status.connecting': 'Connecting',
  'instanceInfoPanel.status.unknown': 'Unknown',
  'instanceInfoPanel.row.status': 'Status',
  'instanceInfoPanel.row.version': 'OpenCode version',
  'instanceInfoPanel.row.skills': 'Skills loaded',
  'instanceInfoPanel.row.sshStatus': 'SSH connection',
  'instanceInfoPanel.version.fetching': 'Fetching...',
  'instanceInfoPanel.version.unknown': 'Unknown',
  ...
  'instanceInfoPanel.plugins.none': 'None',
  'instanceInfoPanel.sshPhase.ready': 'Ready',
  'instanceInfoPanel.sshPhase.error': 'Error',
  'instanceInfoPanel.sshPhase.reconnecting': 'Reconnecting',
  'instanceInfoPanel.sshPhase.resolvingConfig': 'Resolving config',
  'instanceInfoPanel.sshPhase.checkingAuth': 'Checking auth',
  'instanceInfoPanel.sshPhase.connectingSsh': 'Connecting via SSH',
  'instanceInfoPanel.sshPhase.probingRemote': 'Probing remote',
'instanceInfoPanel.sshPhase.installing': 'Installing',
'instanceInfoPanel.sshPhase.installingOpenCode': 'Installing OpenCode CLI',
'instanceInfoPanel.sshPhase.updating': 'Updating',
  'instanceInfoPanel.sshPhase.detectingServer': 'Detecting server',
  'instanceInfoPanel.sshPhase.startingServer': 'Starting server',
  'instanceInfoPanel.sshPhase.forwardingPorts': 'Forwarding ports',
