...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.refresh': 'Odśwież',
  ...
  'chat.compaction.compacting': 'Kompaktowanie…',
  'chat.compaction.compacted': 'Skompaktowano',
  ...
  'contextPanel.split.dropTopHint': 'Upuść, aby podzielić (góra)',
  'contextPanel.split.dropBottomHint': 'Upuść, aby podzielić (dół)',
  'contextPanel.split.closeSplitAria': 'Zamknij podzielony panel',
  'contextPanel.split.resizeAria': 'Zmień rozmiar podzielonych paneli',
  ...
  'desktopHostSwitcher.sshPhase.installingOpenCode': 'Instalowanie OpenCode',
  ...
  'chat.chatInput.actions.queueButton.ctrlEnter': '{ctrlKey}+Click to {action}',
  'chat.chatInput.actions.queueButton.enter': 'Click to {action}',
  'chat.chatInput.actions.queueButton.queue': 'queue',
  'chat.chatInput.actions.queueButton.send': 'send immediately',
  'chat.chatInput.actions.queueMessageTooltip': 'Queue this message — will be sent after the agent finishes',
  'chat.chatInput.actions.sendImmediatelyAria': 'Send immediately',
  'chat.chatInput.actions.sendImmediatelyTooltip': 'Send this message immediately',
  'chat.emptyState.creatingSession': 'chat.emptyState.creatingSession',
  'chat.file.notFound': 'File not found',
  'chat.revertConfirm.cancel': 'Cancel',
  'chat.revertConfirm.confirm': 'Revert',
  'chat.revertConfirm.description': 'This will remove all messages after this point and restore files to their state at this message. The conversation below will be lost.',
  'chat.revertConfirm.title': 'Revert from here?',
  'header.actions.toggleContextPanelAria': 'Toggle context panel',
  'remoteDirectoryExplorer.addProject': 'Add project',
  'remoteDirectoryExplorer.alreadyAdded': 'Already added',
  'remoteDirectoryExplorer.connect': 'Connect',
  'remoteDirectoryExplorer.error': 'Failed to add remote project',
  'remoteDirectoryExplorer.errorFetchHome': 'Failed to determine remote home directory',
  'remoteDirectoryExplorer.errorFetchHomeDetail': 'Could not fetch home directory from {host}. The remote server may not be running or the connection was lost.',
  'remoteDirectoryExplorer.errorFetchList': 'Failed to browse remote directory',
  'remoteDirectoryExplorer.errorFetchListDetail': 'Could not list contents of {path} on {host}. {detail}',
  'remoteDirectoryExplorer.folders': 'Folders',
  'remoteDirectoryExplorer.loading': 'Loading...',
  'remoteDirectoryExplorer.noFolders': 'No folders found',
  'remoteDirectoryExplorer.noHosts': 'No remote servers connected',
  'remoteDirectoryExplorer.pathPlaceholder': 'Enter path...',
  'remoteDirectoryExplorer.phaseConnected': 'Connected',
  'remoteDirectoryExplorer.phaseConnecting': 'Connecting...',
  'remoteDirectoryExplorer.phaseError': 'Connection failed',
  'remoteDirectoryExplorer.retry': 'Retry',
  'remoteDirectoryExplorer.selectHost': 'Select remote server',
  'remoteDirectoryExplorer.success': 'Remote project added',
  'remoteDirectoryExplorer.title': 'Add Remote Project',
  'sessions.sidebar.activity.globalPinnedTitle': 'Global Pinned',
  'sessions.sidebar.bulkActions.archiveConfirm': 'Confirm archive',
  'sessions.sidebar.bulkActions.deleteConfirm': 'Confirm delete',
  'sessions.sidebar.header.actions.addLocalProject': 'Local directory',
  'sessions.sidebar.header.actions.addRemoteProject': 'Remote directory',
  'sessions.sidebar.header.actions.newTempSession': 'New temp session',
  'sessions.sidebar.header.actions.refresh': 'Refresh',
  'sessions.sidebar.project.actions.refresh': 'Refresh',
  'sessions.sidebar.remote.connected': 'Connected',
  'sessions.sidebar.remote.connecting': 'Connecting',
  'sessions.sidebar.remote.disconnected': 'Disconnected',
  ...
  'sessions.sidebar.tempSession.archive': 'Archive',
  'sessions.sidebar.tempSession.archiveError': 'sessions.sidebar.tempSession.archiveError',
  'sessions.sidebar.tempSession.confirm': 'Confirm',
  'sessions.sidebar.tempSession.confirmArchive': 'Confirm archive',
  'sessions.sidebar.tempSession.createError': 'Failed to create temp session',
  'sessions.sidebar.tempSession.createNew': 'Create temp session',
  'sessions.sidebar.tempSession.creating': 'sessions.sidebar.tempSession.creating',
  'sessions.sidebar.tempSession.defaultTopic': 'sessions.sidebar.tempSession.defaultTopic',
  'sessions.sidebar.tempSession.empty': 'New temp session',
  'sessions.sidebar.tempSession.title': 'Temp',
  'sessions.sidebar.tempSession.unavailable': 'sessions.sidebar.tempSession.unavailable',

  'instanceInfoPanel.title': 'Instancja',
  'instanceInfoPanel.empty.noServerFound': 'Nie znaleziono serwera',
  'instanceInfoPanel.empty.hint': 'Aktywna sesja nie należy do zarejestrowanego serwera',
  'instanceInfoPanel.status.healthy': 'Zdrowy',
  'instanceInfoPanel.status.unhealthy': 'Niezdrowy',
  'instanceInfoPanel.status.connecting': 'Łączenie',
  'instanceInfoPanel.status.unknown': 'Nieznany',
  'instanceInfoPanel.row.status': 'Status',
  'instanceInfoPanel.row.version': 'Wersja OpenCode',
  'instanceInfoPanel.row.skills': 'Załadowane umiejętności',
  'instanceInfoPanel.row.sshStatus': 'Połączenie SSH',
  'instanceInfoPanel.version.fetching': 'Pobieranie...',
  'instanceInfoPanel.version.unknown': 'Nieznany',
  'instanceInfoPanel.skills.count': '{count} umiejętności',
  'instanceInfoPanel.row.plugins': 'Wtyczki',
  'instanceInfoPanel.plugins.count': '{count} wtyczek',
  'instanceInfoPanel.plugins.none': 'Brak',
  'instanceInfoPanel.sshPhase.ready': 'Gotowy',
  'instanceInfoPanel.sshPhase.error': 'Błąd',
  'instanceInfoPanel.sshPhase.reconnecting': 'Ponowne łączenie',
  'instanceInfoPanel.sshPhase.resolvingConfig': 'Rozwiązywanie konfiguracji',
  'instanceInfoPanel.sshPhase.checkingAuth': 'Sprawdzanie autoryzacji',
  'instanceInfoPanel.sshPhase.connectingSsh': 'Łączenie przez SSH',
  'instanceInfoPanel.sshPhase.probingRemote': 'Sondowanie zdalne',
  'instanceInfoPanel.sshPhase.installing': 'Instalowanie',
  'instanceInfoPanel.sshPhase.installingOpenCode': 'Instalowanie OpenCode CLI',
  'instanceInfoPanel.sshPhase.updating': 'Aktualizowanie',
  'instanceInfoPanel.sshPhase.detectingServer': 'Wykrywanie serwera',
  'instanceInfoPanel.sshPhase.startingServer': 'Uruchamianie serwera',
  'instanceInfoPanel.sshPhase.forwardingPorts': 'Przekierowywanie portów',
  'instanceInfoPanel.sshPhase.idle': 'Bezczynny',
  'instanceInfoPanel.actions.refreshAria': 'Odśwież informacje o instancji',
  'instanceInfoPanel.actions.manageSettings': 'Zarządzaj w ustawieniach',
} as const;
