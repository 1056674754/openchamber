export const settingsDict = {
  ...
  'settings.openchamber.opencodeServer.state.noConnection': 'No server connection available',
  'settings.openchamber.opencodeServer.state.fetching': 'Fetching...',
  'settings.openchamber.opencodeServer.state.loading': 'Loading...',
  'settings.openchamber.opencodeServer.state.current': 'current',
  'settings.openchamber.opencodeServer.state.skillsCount': '{count} loaded',
  'settings.openchamber.opencodeServer.state.moreSkills': '+{count} more',
  'settings.openchamber.opencodeServer.state.healthy': 'Healthy',
  'settings.openchamber.opencodeServer.state.unhealthy': 'Unhealthy',
  'settings.openchamber.opencodeServer.state.connecting': 'Connecting...',
  'settings.openchamber.opencodeServer.state.unknown': 'Status unknown',
  'settings.openchamber.opencodeServer.state.lastChecked': 'checked {time}',
  'settings.openchamber.opencodeServer.field.version': 'OpenCode Version',
  'settings.openchamber.opencodeServer.field.selectVersion': 'Select version',
  'settings.openchamber.opencodeServer.field.skills': 'Skills',
  'settings.openchamber.opencodeServer.actions.refresh': 'Refresh',
  'settings.openchamber.opencodeServer.actions.upgrade': 'Upgrade',
  'settings.openchamber.opencodeServer.upgrade.success': 'Upgraded to {version}',
  'settings.openchamber.opencodeServer.upgrade.failed': 'Upgrade failed',
  ...
  'settings.openchamber.desktopOpenCode.field.keepAliveAria': 'Keep managed OpenCode running after quitting OpenChamber',
  'settings.openchamber.desktopOpenCode.field.keepAlive': 'Keep OpenCode running after quitting OpenChamber',
  'settings.openchamber.desktopOpenCode.field.keepAliveDescription': 'Preserves the managed OpenCode server so the next desktop launch reuses the same server and sessions instead of starting on a new random port.',
  'settings.openchamber.desktopOpenCode.error.loadFailed': 'Failed to load OpenCode desktop settings',
  'settings.openchamber.desktopOpenCode.error.saveFailed': 'Failed to save OpenCode desktop settings',
  ...
  'settings.openchamber.visual.field.autoCollapseThinkingAria': 'Auto-collapse long thinking',
  'settings.openchamber.visual.field.autoCollapseThinking': 'Auto-collapse Long Thinking',
  'settings.openchamber.visual.field.autoCollapseThinkingThresholdLabel': 'Threshold',
  'settings.openchamber.visual.field.autoCollapseThinkingThresholdUnit': 'chars',
